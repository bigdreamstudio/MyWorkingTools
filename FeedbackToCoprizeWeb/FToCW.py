...
class FToCW(unittest.TestCase):
	...
	def test_FToCW(self):
		filepath = u'/home/micheal/CloudDriver/tempFiles/FeedbackToCoprizeWeb/F2CW.csv'
		...
		for row in xrange(list_rows):
			...
			driver.find_element_by_id(projectId + "_ctl00_ctl04_ctl00_ctl00_ctl00_ctl04_ctl00_ctl00_TextField").send_keys(fTitle + u"(" + fLiability + u")")
